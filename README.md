...
Starting with 11.0.10 the dcevm can be used as replacement of standard JVM. Therefore starting with this release the enhanced redefinition is disabled by default. However it can be enabled using one of the following options:
